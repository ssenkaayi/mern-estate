...
export default function Header() {
    ...
    <header className='big-slate-200 shadow-md'>
        ...
        <div className='flex justify-between  flex-shrink-0 items-center max-w-6xl mx-auto p-3'>

            <Link to='/'>
                <h1 className='font-bold text-sm:text-xt flex flex-wrap flex-shrink-0'>
            ...
            <ul className='flex flex-shrink-0 gap-4 text-slate-700'>
